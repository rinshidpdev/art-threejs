    ...
    <section className="relative bg-black text-white py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-black leading-tight mb-8">
          ...
          <span className="relative inline-block">
            <span className="relative z-10 px-4">IT security</span>
            <span className="absolute inset-0 bg-green-400 rounded-3xl transform -skew-x-3" />
          </span>{" "}
          for good
        </h1>
      ...
      {/* ====== TIMELINE PART (UNDER HERO, SAME TEXT STYLE) ====== */}
      <div className="mt-28 max-w-5xl mx-auto px-4">
        ...
        <div className="grid gap-10 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] mb-16 text-left">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base md:text-lg text-gray-400 leading-relaxed">
              With over 14 years of experience under the Manchi Group, Artflex
        ...
        <div className="mb-24">
          <div className="relative rounded-[32px] overflow-hidden bg-white/5">
            <div className="absolute inset-0 rounded-[32px] bg-[radial-gradient(circle_at_top,_rgba(74,222,128,0.35),_transparent_60%)] pointer-events-none" />
            <img
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            <p className="text-lg md:text-xl text-white font-semibold">
              A cross‑functional team aligned around uptime and security.
            </p>
            <p className="text-base md:text-lg text-gray-400 leading-relaxed mt-3">
              ...
              protection are baked in from day one. [file:157]
            </p>
          </div>
          ...
          <div className="grid gap-10 md:grid-cols-2 items-center w-full mb-20">
            <div className="flex justify-center md:justify-start">
              <div className="relative rounded-[28px] overflow-hidden bg-white/5">
                <div className="absolute inset-0 rounded-[28px] bg-[radial-gradient(circle_at_top,_rgba(34,197,94,0.35),_transparent_60%)] pointer-events-none" />
                <img
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-lg md:text-xl text-white font-semibold">
              A clear direction that keeps every solution focused on security
              and growth.
            </p>
            <p className="text-base md:text-lg text-gray-400 leading-relaxed mt-4">
              <span className="font-bold text-white">Vision.</span> To be the
            ...
            <p className="text-base md:text-lg text-gray-400 leading-relaxed mt-3">
              ...
              while we protect uptime, performance, and data. [file:157]
            </p>
          </div>
